...
lazy_static! {
    ...
    static ref DM_ROLE_ID: serenity::model::id::RoleId = serenity::model::id::RoleId(
        u64::from_str(
            &env::var("DM_ROLE_ID").expect("The environment variable could not be found.")
        )
        .expect("The environment variable could not be parsed.")
    );
